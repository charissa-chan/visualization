...
- For each visualization (good and bad): 
    ...
    - Explain (with reference to material covered up to date, along with readings and other scholarly sources, as needed) why you classified that visualization the way you did.
       ...
       The "Common Mythconceptions" visualization by Tamás Varga is an example of a bad visualization. I come to this conclusion by considering and assessing the aesthetic, substantive, and perceptual qualities of the graph.
        ...
        Second, in terms of the perceptual qualities of the visualization, some organization is provided, but categorizing misconceptions by subject makes it difficult to compare across categories, and it isn't clear what message the visualization is trying to convey. Instead, viewers must hover over each data point individually to read each label, which increases cognitive effort and demands time. This means that the visualization is not very effective, as it could use visual elements like bubble color and position to facilitate easy comparison and highlight trends or relationships between different categories. Ultimately, this issue results from a combination of design errors, not just in terms of visual elements, but perhaps the choice of visualization type as well.
        
        Third, it is uncertain that the data communicated by the visualization is accurate and honest since we are given no indication about the scope of the misconceptions compiled. There is no selection criteria or methodology indicated to explain why only one or two misconceptions are included for some subjects. Furthermore, the categorization is arbitrary and it is unclear why 'nature', 'mind', 'body' 'brain', 'disease' and 'genetics' are set apart from 'science'. As such, the information provided is incomplete, and thus not accurate enough.
    ...
    - How could this data visualization have been improved?  
      ...
      Second, in addition to color-coding, I suggest using a different type of visualization, such as a ranked bar chart or a clustered bubble chart, which will enable easier comparison across data points from each subject category. 

      Finally, the visualization could use clearer indications of scope, methodology and sourcing of data, some of which can be conveyed by the title. For example, simply renaming the chart as "Common MythConceptions: The worlds 100 most contagious falsehoods" already conveys that the dataset is a curated and limited selection.
